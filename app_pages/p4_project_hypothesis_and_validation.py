...
def page_project_hypothesis_body():
    ...
    st.success(
        ...
        f"  * Correct. The correlation study shows that garage area and above ground "
        f"living area are two more of the main indicators of sale price, "
        f"with larger square footage having higher sale price. "
        ...
        f"price however, during feature engineering, they were not found to be "
        f"the features that were most important"
    )
